...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Bachelor of Electrical and Electronic Engineering (BE) Honours Degree}{Sept. 2012 -- May 2017}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{API Integration: Working with OpenAPI documentation and third party APIs to facilitate a complete new integration with an exam provider}
...
%-------------------------------------------
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        Glanbia. Responsibilities included:}
        \resumeItem{Wonderware InTouch SCADA development – developed application scripts, graphical
        properties, alarm handling logic and historical database development. (c. 18 Main Screen)}.
        \resumeItem{PLC Code: I/O Scaling, alarm handling logic, process improvements/amendments during commissioning.}
  \resumeSubHeadingListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
          {\textbf{Exam Invigilator Dashboard} $|$ \emph{JavasScript, Tailwind, AJAX, SQL}}{Mar 2024 -- April 2024}
          ...
          \resumeItemListStart
            ...
            \resumeItem{Implemented modals for detailed candidate review, allowing invigilators to update ID check status, exam review status, and add notes.}
